...
const response = await fetch('https://api.openai.com/v1/chat/completions', {
    ...
    headers: {
        ...
        'Authorization': 'Bearer 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' // Thay thế bằng API key của bạn
    },
    body: JSON.stringify({
        model: "gpt-4o",
        messages: [{
